...
var file_internal_conf_conf_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x8c, 0x01, 0x0a, 0x09, 0x42, 0x6f, 0x6f, 0x74, 0x73, 0x74,
	...
	0x73, 0x74, 0x65, 0x72, 0x22, 0xb6, 0x02, 0x0a, 0x06, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72, 0x12,
	0x2a, 0x0a, 0x04, 0x68, 0x74, 0x74, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e,
	0x75, 0x73, 0x65, 0x72, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x65, 0x72,
	0x2e, 0x48, 0x54, 0x54, 0x50, 0x52, 0x04, 0x68, 0x74, 0x74, 0x70, 0x12, 0x2a, 0x0a, 0x04, 0x67,
	0x72, 0x70, 0x63, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x75, 0x73, 0x65, 0x72,
	...
	0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e,
	...
	0x72, 0x65, 0x64, 0x69, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x75, 0x73,
	0x65, 0x72, 0x2e, 0x63, 0x6f, 0x6e, 0x66, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x52, 0x65, 0x64,
	...
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x1a, 0xc5, 0x01, 0x0a, 0x05, 0x52, 0x65, 0x64, 0x69, 0x73, 0x12,
	...
	0x0e, 0x0a, 0x02, 0x64, 0x62, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x64, 0x62, 0x12,
	...
	0x0c, 0x77, 0x72, 0x69, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x72, 0x0a,
	0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x12, 0x2f, 0x0a, 0x05, 0x6e, 0x61, 0x63,
	0x6f, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e,
	0x63, 0x6f, 0x6e, 0x66, 0x2e, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x72, 0x79, 0x2e, 0x4e, 0x61,
	...
	0x74, 0x42, 0x25, 0x5a, 0x23, 0x61, 0x70, 0x70, 0x2f, 0x75, 0x73, 0x65, 0x72, 0x2f, 0x73, 0x65,
...
var file_internal_conf_conf_proto_goTypes = []interface{}{
	...
	(*Server_HTTP)(nil),         // 4: user.conf.Server.HTTP
	(*Server_GRPC)(nil),         // 5: user.conf.Server.GRPC
	(*Data_Database)(nil),       // 6: user.conf.Data.Database
	(*Data_Redis)(nil),          // 7: user.conf.Data.Redis
	(*Registry_Nacos)(nil),      // 8: user.conf.Registry.Nacos
...
var file_internal_conf_conf_proto_depIdxs = []int32{
	...
	4,  // 3: user.conf.Server.http:type_name -> user.conf.Server.HTTP
	5,  // 4: user.conf.Server.grpc:type_name -> user.conf.Server.GRPC
	6,  // 5: user.conf.Data.database:type_name -> user.conf.Data.Database
	7,  // 6: user.conf.Data.redis:type_name -> user.conf.Data.Redis
	8,  // 7: user.conf.Registry.nacos:type_name -> user.conf.Registry.Nacos
	9,  // 8: user.conf.Server.HTTP.timeout:type_name -> google.protobuf.Duration
	9,  // 9: user.conf.Server.GRPC.timeout:type_name -> google.protobuf.Duration
	9,  // 10: user.conf.Data.Redis.read_timeout:type_name -> google.protobuf.Duration
	9,  // 11: user.conf.Data.Redis.write_timeout:type_name -> google.protobuf.Duration
